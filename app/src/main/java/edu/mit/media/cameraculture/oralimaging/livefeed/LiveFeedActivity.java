...
/**
 * Created by judychang on 12/14/15.
 */
public class LiveFeedActivity extends CardboardActivity implements CardboardView.StereoRenderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        cardboardView = (CardboardView) findViewById(R.id.livefeed_view);
        cardboardView.setRenderer(this);
        setCardboardView(cardboardView);

        mCamera = new float[16];
        mView = new float[16];
        mOverlayView = (LiveFeedOverlayView) findViewById(R.id.livefeed_overlay);
